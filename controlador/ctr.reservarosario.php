...
if(isset($_POST['action']) == 'registrohotelerosario'){
    $conte = json_decode($_POST['conteHotelRosario']);
    ...
    if(!empty($_POST['conteHotelRosario']) ||!empty($id_usuario)||!empty($usuario_actual)){
            ...
            if($capturar_reserva->affected_rows){
                ...
                if($existe_reservacion){
                    ...
                    foreach($conte as $valor){
                        $id_habi = $valor->habitacion;
                        $adultos = $valor->adultoh;
                        $ninos = $valor->ninoh;
                        $total = $valor->totalh;
                    ...
                    if($captura_ha->affected_rows){
                        ...
                        if($existe_ha){
                            ...
                            if(!$actulizar_estado -> error){
                                 ...
                                 $descp = "Reservación de hotel en Rosario realizada correctamente";
                                 //include("../modelo/conexionbd.php");
