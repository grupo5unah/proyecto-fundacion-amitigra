        ...
        public function ctrNuevaContrasena(){
            ...
            if(isset($_GET['eid']) && isset($_GET['tkn']) && isset($_GET['exd'])){
                ...
                if($expire_date <= $current_date) {
                    echo "<div class='alert alert-orange' role='alert'>
                    ...
                    if(isset($_POST['tipo']) == 'nuevaContrasena') {
                        ...
                        if($password == $confpassword) {
                            ...
                            $Verificar = $conn->prepare("SELECT id_usuario, nombre_usuario FROM tbl_usuarios WHERE validacion_token = ? ;");
                            ...
                            if($Verificar->affected_rows){
                                ...
                                if(!$existe){
                                    ...
                                    if(!preg_match($pattern_up, $password)) {
                                        ...
                                        SET contrasena = ?, validacion_token = ?, primer_ingreso = ?, estado_usuario = ?, fecha_vencimiento = ?
                                        WHERE id_usuario = ?;");
                                        $Actualizacion->bind_Param("sssssi", $hash_password, $vacio, $fecha_hoy, $estado_del_usuario, $nueva_fecha_vencimiento, $id_usuario);
                                        ...
                                        if($Actualizacion->error) {
                                            ...
                                            echo "<div class='alert alert-success' role='alert'>
                                                ...
                                                $actualizarPassword->bind_Param("siiss",$fecha_actualizacion,$id_usuario, $id_objeto, $acciones, $descripcion);
