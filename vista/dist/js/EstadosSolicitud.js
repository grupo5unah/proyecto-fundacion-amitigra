$(document).ready(function () {
  $("#mantEstadosSolicitudes").DataTable({
    ...
    buttons: [
...

      {
        ...
        pageSize: "A4",
        title: "REPORTE DE ESTADOS DE SOLICITUDES",
       // messageTop: "REPORTE DE ESTADOS DE SOLICITUDES.",
  ...
  $("#formEstadoSolicitudes").submit(async function (e) {
    ...
    if (estadoSolicitud != undefined && usuario_actual != undefined) {
      ...
      const resp = await axios.post(
        "./controlador/apiEstadoSolicitudes.php?action=registrarEstadoSolicitud",
        formData
      );
