$(document).ready(function () {
    ...
    buttons: [
...

      {
        ...
        customize: function (doc) {
          ...
          cols[1] = {
            text: moment().format(" M/D/Y, h:mm:ss"),
            alignment: "right",
            margin: [10, 10, 15, 15],
          };
          var objHeader = {};
  ...
  $(".btnEditarSolicitud").on("click", function () {
    ...
    const fechacreacion = $(this).data("fechacreacion");
    ...
    $("#idsolicitud").val(idsolicitud),
      ...
      $("#fecha_registro").val(fechacreacion),
    ...
    $(".btnEditarBD").on("click", async function () {
      ...
      formData.append("fecha_creacion", $("#fecha_registro").val());
      formData.append("usuario_actual", usuario_actual);
