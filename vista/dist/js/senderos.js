...
$(document).ready(function(){
 ...
 /**SENDERO NACIONAL*/
  ...
  $('.btnEliminarBoleto').on('click', function (){    
    ...
    swal("Eliminar Boleto(s)", "¿Esta seguro de eliminar esta Facturacion?", "warning",{buttons: ["Cancelar", "Aceptar"], 
  ...
  $('.btnVerdDetalle').click(async function () {

    let idbolvendido = $(this).data('idbolvendido');
    ...
    if(idbolvendido){
        try{
            ...
            tot.append(
              ...
              <div class="user col-3 tamano">
              <label for="" id="total"> TOTAL A PAGAR ====> ${total}</label>
              </div>
