    ...
    buttons: [
     'pageLength',
      ...
      },
      {
        ...
        messageTop: 'REPORTE MOVIMIENTOS DE INVENTARIO',
        exportOptions: {
          columns: [ 0, ':visible' ]
      },
    },
  ...
  $("#managerTp").DataTable({
    ...
    buttons: [
      ...
      },
      {
        ...
        titleAttr: "Imprimir",
        title: "FUNDACION AMIGOS DE LA TIGRA",
        messageTop: " REPORTE DE Tipo de PRODUCTO.",
        className: "btn btn-dark",
        exportOptions: {
          modifier: {
            page: "current",
...

      {
        ...
        orientation: "portrait",
        pageSize: "A4",
        title: "REPORTE DE TIPO DE PRODUCTO",
       //messageTop: "REPORTE DE TIPO DE PRODUCTO.",
        Image: "fotoPerfil/foto1.png",
        download: "open",
        exportOptions: {
    ...
    buttons: [
     ...
     },
      {
        ...
        customize: function (doc) {
          ...
          doc["content"]["1"].layout = "lightHorizontalLines";
          doc['content']['1'].table.widths = ['30%','15%','20%', 150, 15, 15];
          doc["content"]["1"].style = "lightHorizonalLines";
  ...
  $("#managerRoles").DataTable({
    ...
    buttons: [
      ...
      },
      {
        ...
        titleAttr: "Imprimir",
        title: "FUNDACION AMIGOS DE LA TIGRA",
        messageTop: " REPORTE DE ROLES DE USUARIO.",
        className: "btn btn-dark",
        exportOptions: {
          modifier: {
            page: "current",
...

      {
        ...
        orientation: "portrait",
        pageSize: "A4",
        title: "REPORTE DE ROLES DE USUARIO",
        //messageTop: " REPORTE DE ROLES DE USUARIO.",
        Image: "fotoPerfil/foto1.png",
        download: "open",
        exportOptions: {
  ...
  $("#managerPreguntas").DataTable({
    ...
    buttons: [
      ...
      },
      {
        ...
        titleAttr: "Imprimir",
        title: "FUNDACION AMIGOS DE LA TIGRA",
        messageTop: " REPORTE DE PREGUNTAS DE USUARIO..",
        className: "btn btn-dark",
        exportOptions: {
          modifier: {
            page: "current",
...

      {
        ...
        orientation: "portrait",
        pageSize: "A4",
        title: "REPORTE DE PREGUNTAS DE USUARIO",
        //messageTop: " REPORTE DE PREGUNTAS DE USUARIO.",
        Image: "fotoPerfil/foto1.png",
        download: "open",
        exportOptions: {
  ...
  $("#managerObjetos").DataTable({
    ...
    buttons: [
      ...
      },
      {
        ...
        titleAttr: "Imprimir",
        title: "FUNDACION AMIGOS DE LA TIGRA",
        messageTop: " REPORTE DE OBJETOS DEL SISTEMA.",
        className: "btn btn-dark",
        exportOptions: {
          modifier: {
            page: "current",
...

      {
        ...
        orientation: "portrait",
        pageSize: "A4",
        title: " REPORTE DE OBJETOS DEL SISTEMA",
        //messageTop: " REPORTE DE OBJETOS DEL SISTEMA.",
        Image: "fotoPerfil/foto1.png",
        download: "open",
        exportOptions: {
...

      {
        ...
        customize: function (doc) {
          ...
          cols[0] = {
            text: "AMITIGRA",
            alignment: "left",
            margin: [15, 10, 10, 10, 10],
          };
          cols[1] = {
            text: moment().format(" MMMM D ddd YYYY, h:mm:ss"),
            alignment: "right",
            margin: [10, 10, 15, 15],
          };
          var objHeader = {};
  ...
  $("#mantMovimiento").DataTable({
    ...
    buttons: [
      ...
      },
      {
        ...
        titleAttr: "Imprimir",
        title: "FUNDACION AMIGOS DE LA TIGRA",
        messageTop: " REPORTE DE TIPO DE MOVIMIENTO",
        className: "btn btn-dark",
        exportOptions: {
          modifier: {
            page: "current",
      ...
      },
      {
        ...
        text: '<i class="fas fa-file-excel">',
        className: "btn btn-success",
        messageTop: " REPORTE DE TIPO MOVIMIENTO",
        exportOptions: {
          columns: [0, ":visible"],
        },
      },
      ...
      
      {
        ...
        orientation: "portrait",
        pageSize: "A4",
        title: " REPORTE DE TIPO MOVIMEINTO",
        //messageTop: " REPORTE DE PRODUCTOS.",
        Image: "fotoPerfil/foto1.png",
        download: "open",
        exportOptions: {
