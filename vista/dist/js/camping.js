...
$(document).ready(function () {
    ...
    $('#mantDetReservaCTable').DataTable({
    ...
    // },
      ...
      dom: 'Bfrtip',
        ...
        },
        {
            ...
            messageTop:' REPORTE DETALLE DE RESERVACIONES CAMPING.',
           ...
           
            {
                ...
                messageTop: 'REPORTE DETALLE RESERVACIONES CAMPING.',
  ...
  $('#localidad').change(function() {
    ...
    console.log(local);
    if(local==1){
      $('#modalRegistrarCamping').modal('show');
    }
  });
  /**FUNCION PARA REALIZAR LA RESERVACION EN CAMPING */
  $("#formCamping").submit(async function(e){
    e.preventDefault();
