...
{
  try {
    var cantTienda2=parseFloat(document.getElementById("canTi").value)|| 0, 
        precioT2=parseFloat(document.getElementById("precioT2").value)|| 0;          
        document.getElementById("totaltienda2").value= (cantTienda2*precioT2);
  }catch(e){

  }
}
//FUNCION PARA CALCULAR EL TOTAL TIENDA PARA 4 PERSDONAS
function calcularCamping4()
{
  try {
    var cantTienda4=parseFloat(document.getElementById("canTi4").value)|| 0, 
        precioT4=parseFloat(document.getElementById("precioT4").value)|| 0;          
        document.getElementById("totaltienda4").value= (cantTienda4*precioT4);
  }catch(e){

  }
}
//FUNCION PARA CALCULAR EL TOTAL SLEEPING BAG PERSDONAS
function calcularSleeping()
{
  try {
    var cantSleeping=parseFloat(document.getElementById("canS").value)|| 0, 
        precioSleeping=parseFloat(document.getElementById("precioS").value)|| 0;          
        document.getElementById("totalSleep").value= (cantSleeping*precioSleeping);
  }catch(e){
