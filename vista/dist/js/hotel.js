...
//FUNCION PARA CALCULAR EL TOTAL EN HOTEL JUTIAPA NACIONALES Y EXTRANJEROS
function calcular()
{
  try {
    var cant_adultosN=parseFloat(document.getElementById("cAdultosN").value)|| 0, 
        cant_niñosN=parseFloat(document.getElementById("cNinosN").value)|| 0,
        precio_adultoN=parseFloat(document.getElementById("precioAdultoN").value)|| 0,
        precio_niñosN=parseFloat(document.getElementById("precioNinoN").value)|| 0; 
        cant_adultosE=parseFloat(document.getElementById("cantAdultosE").value)|| 0, 
        cant_niñosE=parseFloat(document.getElementById("cantNinosE").value)|| 0,
        precio_adultoE=parseFloat(document.getElementById("precioAdultoE").value)|| 0,
        precio_niñosE=parseFloat(document.getElementById("precioNinoE").value)|| 0;          
        document.getElementById("total1").value= (cant_adultosN*precio_adultoN)+(cant_niñosN*precio_niñosN);
        document.getElementById("total2").value= (cant_adultosN*precio_adultoN)+(cant_niñosN*precio_niñosN)
        +(cant_adultosE*precio_adultoE)+(cant_niñosE*precio_niñosE);
  }catch(e){

  }
}
//FUNCION PARA CALCULAR EL TOTAL EN HOTEL ROSARIO NACIONALES Y EXTRANJEROS
function calcular1()
{
  try {
    var cant_adultosN=parseFloat(document.getElementById("cAdultN").value)|| 0, 
        cant_niñosN=parseFloat(document.getElementById("cNiN").value)|| 0,
        precio_adultoN=parseFloat(document.getElementById("preAdultoN").value)|| 0,
        precio_niñosN=parseFloat(document.getElementById("preNinoN").value)|| 0; 
        cant_adultosE=parseFloat(document.getElementById("cantAdultE").value)|| 0, 
        cant_niñosE=parseFloat(document.getElementById("cantNiE").value)|| 0,
        precio_adultoE=parseFloat(document.getElementById("preAdultE").value)|| 0,
        precio_niñosE=parseFloat(document.getElementById("preNinoE").value)|| 0;          
        document.getElementById("total3").value= (cant_adultosN*precio_adultoN)+(cant_niñosN*precio_niñosN);
        document.getElementById("total4").value= (cant_adultosN*precio_adultoN)+(cant_niñosN*precio_niñosN)
        +(cant_adultosE*precio_adultoE)+(cant_niñosE*precio_niñosE);
  }catch(e){
...
$(document).ready(function () {
  ...
  $('#mantDetReservaTable').DataTable({
     //centrar informacion de las columnas 
    colmnDefs:[
  ...
  //Date picker para fecha reservacion Rosaio
  $('#reserva').datepicker({
    autoclose: true 
  });
  //Date picker para entrada
