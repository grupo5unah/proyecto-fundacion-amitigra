                  ...
                  <div class="panel-heading">
                    ...
                    <div class="box-body">
                      ...
                      <div class="div-action pull pull-right" style="padding-bottom:20px;">
                        ...
                        <button class="btn btn-success btnCrearSolicitud glyphicon glyphicon-plus-sign"> AGREGAR NUEVA SOLICITUD</button>
                      </div> <!-- /div-action -->
                      <table id="tablaSolicitudes" class="display responsive nowrap">
                        ...
                        <tbody>
                          ...
                          cli.telefono,tiponac.id_tipo_nacionalidad,tiponac.nacionalidad,tips.id_tipo_solicitud,sol.fecha_creacion,
                ...
                <div class="modal-body">
                  ...
                  where estado_eliminado=1");
                    ...
                    <div class="modal-footer">
                      ...
                      <button type="button" class="btn btn-danger" data-dismiss="modal" id="cerrarFormact">Cancelar</button>
                      <input id="btnEditarBD" type="button" class="btnEditarBD btn btn-success" type="text" value="Actualizar"><br>
              ...
              <div class="modal-content">
                ...
                where estado_eliminado=1");
                    ...
                    where estado_eliminado=1");
                      ...
                      <div class="modal-footer">
                        <button id="cerrar_rs" type="button" class="btn btn-danger" data-dismiss="modal">Cancelar</button>
